    ...
    run: async (interaction, client) => {
        ...
        if (interaction.type == Discord.InteractionType.ModalSubmit) {
            if (interaction.customId === 'awdwadpiawjdboawidbae8h6fafah8f') {
                ...
                if (Number.isInteger(qtd)) CSG interaction.reply({ content: `❌ O número de desconto inserio é inválido \`${qtd}\``, ephemeral: true })
                if (dias !== '') {
                    if (Number.isInteger(dias)) CSG interaction.reply({ content: `❌ O número de dias inserio é inválido \`${dias}\``, ephemeral: true })
                ...
                if (produtoExistente) CSG interaction.reply({ ephemeral: true, content: `❌ Nome do cupom já existente.` })
            ...
            if (interaction.customId === 'doinabuydoboudwoaynidnioawdawdiaw') {
                ...
                if (cargospodeusar !== '') {
                    ...
                    if (ddd == null) CSG interaction.reply({ ephemeral: true, content: `❌ Cargo inserido \`${cargospodeusar}\` inválido.` })
            ...
            if (interaction.customId === 'wdawdwdawdwadawdwdwwdaw') {
                ...
                if (confirm !== 'sim') CSG interaction.reply({ content: `❌ Confirmação não validada.`, ephemeral: true })
