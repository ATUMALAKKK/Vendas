        ...
        if (interaction.type == Discord.InteractionType.ModalSubmit) {
            if (interaction.customId === 'sdaju11111idsjjs123dua123') {
                ...
                if (a1 !== '') {
                    if (regexPadrao.test(a1)) {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cor \`${a1}\` inválida (Principal).` })
                    }
                }
                if (a2 !== '') {
                    if (regexPadrao.test(a2)) {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cor \`${a2}\` inválida (Processamento).` })
                    }
                }
                if (a3 !== '') {
                    if (regexPadrao.test(a3)) {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cor \`${a3}\` inválida (Sucesso).` })
                    }
                }
                if (a4 !== '') {
                    if (regexPadrao.test(a4)) {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cor \`${a4}\` inválida (Falha).` })
                    }
                }
                if (a5 !== '') {
                    if (regexPadrao.test(a5)) {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cor \`${a5}\` inválida (Finalizado).` })
                    }
                }

                interaction.reply({ content: `${Emojis.get('checker')} Cores atualizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'sdaju11111231idsjjs123dua123') {
                ...
                if (a1 !== '') {
                    try {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Nome inserido \`${a1}\` inválido ou então você alterou mais de 3 vezes o nome em 1 hora!` })
                    }
                }
                if (a2 !== '') {
                    try {
                        ...
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Avatar inserido \`${a2}\` inválido.` })
                    }
                }
                ...
                await interaction.reply({ content: `${Emojis.get('checker')} Configurações atualizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'dassdadassddsdasddassddasd') {
                ...
                if (ADD !== '') {
                    ...
                    if (ddd == null) CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cargo inserido \`${ADD}\` inválido.` })
                ...
                if (REM !== '') {
                    ...
                    if (ddd == null) CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cargo inserido \`${REM}\` inválido.` })
                ...
                interaction.followUp({ content: `${Emojis.get('checker')} Alterações realizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'configcampoo') {
                ...
                if (isNaN(preco)) CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Preço inserido \`${preco}\` inválido.` })
                ...
                if (ggg.camposelect !== nomecampo) {
                    ...
                    if (produtoExistente) CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Nome do campo já existente.` })
                }
            ...
            if (interaction.customId == 'definircondicoes') {
                ...
                if (idcargo !== '') {
                    ...
                    if (ddd == null) CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Cargo inserido \`${idcargo}\` inválido.` })
                }

                if (valorminimo !== '') {
                    valorminimo = parseInt(valorminimo, 10);
                    if (!Number.isInteger(valorminimo)) {
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Quantidade inserida \`${valorminimo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
                ...
                if (valormaximo !== '') {
                    ...
                    if (!Number.isInteger(valormaximo)) {
                        CSG interaction.reply({ ephemeral: true, content: `${Emojis.get('negative')} Quantidade inserida \`${valormaximo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
...
**Deseja adicionar o valor de \`${qtdlinhas}\`\ itens ao estoque de \`${ggg22.campo}\`?**
            ...
            if (interaction.customId == 'sd1213aju11111idsjjsdua') {
                ...
                if (qtd > 100000) CSG interaction.reply({ content: `${Emojis.get('negative')} Não foi possível adicionar esse estoque.`, ephemeral: true })

                if (isNaN(qtd)) CSG interaction.reply({ content: `${Emojis.get('negative')} Esse número não é válido \`${qtd}\`.`, ephemeral: true })
                ...
                await interaction.reply({ content: `${Emojis.get('loading')} Aguarde...`, ephemeral: true }).then(async tt => {
                    ...
                    await tt.edit({ content: `${Emojis.get('loading')} Sincronizando mensagens...`, ephemeral: true }).then(async msg => {
                        await UpdateMessageProduto(client, ggg.name)

                    })

                    await tt.edit({ content: `${Emojis.get('checker')} Total de \`${qtd}\` itens fantasma adicionado ao estoque.`, ephemeral: true })
                })
            ...
            if (interaction.customId == 'sdaju11124124111231idsjjs123dua123') {
                ...
                if (qtd !== 'sim') CSG interaction.reply({ content: `${Emojis.get('negative')} Confirmação não validada.`, ephemeral: true });
                ...
                try {
                    const syncMessage = await interaction.followUp({ content: `${Emojis.get('loading')} Sincronizando mensagens...`, ephemeral: true, fetchReply: true });
                    await UpdateMessageProduto(client, ggg.name);

                    interaction.editReply({ message: syncMessage, content: `${Emojis.get('checker')} Processo concluído!` })
        ...
        if (interaction.isButton()) {
                ...
                interaction.reply({ ephemeral: true, content: `❓ Envie um ou mais arquivo de texto contendo o estoque que deseja adicionar, expira <t:${Math.ceil(timeStamp / 1000)}:R>.` }).then(msgggg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        if (message.attachments.size !== 0) {
                            ...
                            await interaction.editReply({ embeds: [], components: [], content: `${Emojis.get('loading')} Aguarde...` })
                    ...
                    collector.on('end', async (message) => {
                        collector.stop()
                        if (message.size >= 1) CSG

                        msgggg.edit({ content: `${Emojis.get('avisus')} Tempo esgotado...` })
                    })
                })
            ...
            if (interaction.customId == 'simestoque') {
                ...
                await interaction.editReply({ content: `${Emojis.get('loading')} Sincronizando mensagens...`, ephemeral: true })
            ...
            if (interaction.customId.startsWith('avisarestoqueeeee')) {
                ...
                if (yy == 0 || yy == undefined) CSG interaction.update({ content: `${Emojis.get('negative')} Nenhum usuário para avisar.`, ephemeral: true, components: [] })
                ...
                interaction.update({ content: `${Emojis.get('checker')} Avisamos os ${yy.length} que seu produto foi reabastecido com sucesso!`, ephemeral: true, components: [] })
            ...
            if (interaction.customId == 'estoquedsadas') {
                ...
                if (gggaaa.estoque == 0) {
                    interaction.reply({ content: `${Emojis.get('avisus')} O estoque desse item está vazio.`, ephemeral: true })
                } else {
            ...
            if (interaction.customId == 'excluirproduto') {
                ...
                interaction.followUp({ content: `${Emojis.get('checker')} Produto excluído com sucesso!`, ephemeral: true })
            }
            ...
            if (interaction.customId == 'gwdawdwadawawderenciarcampossss') {
                ...
                const newnameboteN = new TextInputBuilder()
                    ...
                    .setPlaceholder(`Insira algum id de cargo que será necessário para comprar`)
                    .setStyle(TextInputStyle.Short)
                    .setRequired(false)
                ...
                const newnameboteN2 = new TextInputBuilder()
                    ...
                    .setPlaceholder(`Insira um valor mínimo necessário para a compra`)
                    .setStyle(TextInputStyle.Short)
                    .setRequired(false)
                ...
                const newnameboteN4 = new TextInputBuilder()
                    ...
                    .setPlaceholder(`Insira um valor máximo necessário para a compra`)
                    .setStyle(TextInputStyle.Short)
                    .setRequired(false)
