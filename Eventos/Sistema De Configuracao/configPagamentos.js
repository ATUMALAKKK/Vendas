    ...
    run: async (interaction, client) => {
        ...
        if (interaction.type == InteractionType.ModalSubmit) {
            ...
            if (interaction.customId === 'sdaju111idsjjsdua') {
                ...
                if (title2 !== '') {
                    if (isNaN(title2) == true) CSG interaction.reply({ content: `❌ | Você colocou um tempo incorreto para a mensagem ser apagada!`, ephemeral: true })
                } else {
                    title2 = 0
                }
            ...
            if (interaction.customId === 'tokenMP') {
                ...
                try {
                    ...
                    const payment_data = {
                        ...
                        payer: {
                            email: 'stormappsrecebimentos@contasesuportegamehub.com',
