...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (msg.type == 2) {
      ...
      if (produto == undefined) CSG interaction.reply({ content: `❌ | Produto não encontrado.`, ephemeral: true })
      const aa = produtos.get(produto)
      if(aa == null) CSG interaction.reply({ content: `❌ | Produto não encontrado.`, ephemeral: true })
